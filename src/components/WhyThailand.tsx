...
const WhyThailand = () => {
  ...
  return (
    <section id="why-thailand" className="py-20 bg-vestors-lightgray">
      <div className="container mx-auto px-4">
          ...
          {reasons.map((reason, index) => (
            <Card key={index} className="border-none shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-6">
                <div className="rounded-full w-12 h-12 flex items-center justify-center mb-4 text-white bg-yellow-600">
                  {reason.icon}
                </div>
        ...
        <div className="mt-16 text-center">
          <Button className="bg-vestors-blue hover:bg-yellow-600 text-white px-8 py-6 text-lg">
